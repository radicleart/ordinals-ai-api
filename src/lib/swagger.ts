export const swagger = {
	...
	"paths": {
		...
		"/runes-api/{network}/v1/btc/tx/{txid}": {
			"get": {
		...
		"/runes-api/{network}/v1/btc/wallet/address/{address}/utxos": {
			"get": {
		...
		"/runes-api/{network}/v1/sbtc/events": {
			"get": {
		...
		"/runes-api/{network}/v1/sbtc/events/{page}": {
			"get": {
		...
		"/runes-api/{network}/v1/sbtc/address/{address}/balance": {
			"get": {
		...
		"/runes-api/{network}/v1/sbtc/data": {
			"get": {
		...
		"/runes-api/{network}/v1/sbtc/wallet-address": {
			"get": {
